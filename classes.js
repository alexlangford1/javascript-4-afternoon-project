...
let numb = new Machine(0, 0, false);
numb.makeWidgets(10);
numb.makeWidgets(1);
numb.makeWidgets(39);
numb.makeWidgets(1000);
console.log(numb.widgets_made_count)
numb.fixMachine()
console.log(numb.wear_and_tear_count)
numb.reboot()()
console.log(numb.needs_reboot)